...
st.write(
    """
# Infinite Bookshelf: Write full books using llama3.2 (11b and 90b) on Groq
"""
)
...
try:
    ...
    if submitted:
        ...
        total_generation_statistics = GenerationStatistics(model_name="llama-3.2-11b-vision-preview")
